...
| `NEXT_PUBLIC_GITHUB_URL` | GitHub Profile URL | `https://github.com/shubhamacharya02` |
| `NEXT_PUBLIC_GITHUB_USERNAME` | GitHub Username (for live API stats) | `shubhamacharya02` |
...
| `NEXT_PUBLIC_NEXUS_AI_GITHUB_URL` | Nexus AI GitHub repository | `https://github.com/shubhamacharya02/Nexus_AI_Backend` |
| `NEXT_PUBLIC_NEXUS_AI_LIVE_URL` | Nexus AI Live demo URL | `https://nexus-ai-frontend-nine.vercel.app/` |
| `NEXT_PUBLIC_PREPMATE_AI_GITHUB_URL` | PrepMate AI GitHub repository | `https://github.com/shubhamacharya02/Prepmate-AI-backend` |
